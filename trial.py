...
if __name__ == '__main__':
    ...
    if opt.epoch is not None:
        ...
        for epoch in range(int(opt.epoch) , opt.n_epochs + opt.n_epochs_decay + 1):    # outer loop for different epochs; we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>
